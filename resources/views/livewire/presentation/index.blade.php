<div 
    ...
    class="fixed inset-0 bg-[#1a1c23] text-white overflow-hidden"
>
    {{-- Progress Bar --}}
    <div class="fixed top-0 left-0 right-0 h-1 bg-gray-800">
        <div 
    ...
    <div class="fixed bottom-4 right-4 opacity-10">
